...
static const char* STR_ME_MUTATE_FREEZE_STATE = "Mutate freeze state";
...
static const char* STR_IT_funds_backer = "Funds backer";
...
static const char* STR_IT_bidder = "Bidder";
